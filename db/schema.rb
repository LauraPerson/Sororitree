...
ActiveRecord::Schema.define(version: 2020_06_13_140311) do
  ...
  create_table "profile_avatars", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["avatar_id"], name: "index_profile_avatars_on_avatar_id"
    t.index ["user_id"], name: "index_profile_avatars_on_user_id"
  end
  ...
  create_table "selected_themes", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["theme_id"], name: "index_selected_themes_on_theme_id"
    t.index ["user_id"], name: "index_selected_themes_on_user_id"
  end
  ...
  add_foreign_key "selected_themes", "users"
end
