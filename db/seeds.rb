...
post8 = {
  user_id: User.find(rand(User.first.id..User.last.id)).id,
  theme_id: Theme.find(5).id,
  content: "Relato de assédio: “Uma semi-desconhecida me salvou. Ela me conhecia de vista e me viu sentada num canto alcoolizada, depois viu um cara que era totalmente desconhecido me carregando dali. Daí ela estranhou e foi lá perguntar e ele disse que eramos amigos e ele estaria me levando pra casa. Ela disse: “Poxa, que bom, tinha me perdido dela, ia dormir na casa dela, vou junto”. Só que o cara disse que não rolava. Ela insistiu nisso e ele acabou indo embora. Depois ela me descreveu a figura e de fato NUNCA tinha visto o sujeito."
}
